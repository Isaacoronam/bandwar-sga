...
El proyecto sigue **Semantic Versioning (SemVer)**: `MAJOR.MINOR.PATCH`

- **MAJOR** (X.0.0): Cambios incompatibles, cambios de API
- **MINOR** (0.X.0): Nuevas funcionalidades compatibles
- **PATCH** (0.0.X): Correcciones de bugs

Las versiones se etiquetan en `main` cuando hay una entrega importante.

---

## 9. Preguntas Frecuentes

**P: ¿Puedo trabajar en dos features al mismo tiempo?**  
R: Sí, pero crea ramas separadas (`feature/feature-1` y `feature/feature-2`) y PRs independientes.

**P: ¿Qué pasa si hay conflictos al mergear?**  
R: Git notificará sobre conflictos. Resuélvelos localmente, haz commit y pushea de nuevo.

**P: ¿Puedo cambiar un commit ya pusheado?**  
R: Solo si no ha sido mergeado a `develop` o `main`. Usa `git push --force-with-lease` (¡cuidado!).

**P: ¿Dónde reparto bugs o tareas?**  
R: Usa GitHub Issues o el sistema de tickets del equipo. Crea ramas basadas en esos issues.

---

## 📞 Soporte

Contacta al líder del equipo si tienes dudas sobre el flujo de trabajo o necesitas ayuda con Git.